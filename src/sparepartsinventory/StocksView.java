 ...
 * @author Lenovo
 */
public class StocksView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        stock.setAutoCreateRowSorter(true);
        stock.setBackground(new java.awt.Color(21, 67, 96));
        stock.setBorder(javax.swing.BorderFactory.createCompoundBorder());
        stock.setFont(new java.awt.Font("Square721 BT", 1, 18)); // NOI18N
        ...
        stock.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Id", "Name", "Price", "Quantity", "Material"
            }
        ));
        stock.setAlignmentX(1.0F);
        stock.setAlignmentY(1.0F);
        stock.setEnabled(false);
        stock.setRowHeight(35);
        ...
        if (stock.getColumnModel().getColumnCount() > 0) {
            stock.getColumnModel().getColumn(0).setHeaderValue("Item Id");
            stock.getColumnModel().getColumn(1).setHeaderValue("Name");
            stock.getColumnModel().getColumn(2).setHeaderValue("Price");
            stock.getColumnModel().getColumn(3).setHeaderValue("Quantity");
            stock.getColumnModel().getColumn(4).setHeaderValue("Material");
        }
    ...
    private void putData(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_putData
        // TODO add your handling code here:
        DefaultTableModel df = (DefaultTableModel)stock.getModel();
        ...
        try{
            ...
            ResultSet rs3 = st.executeQuery("select * from products, i_detail where products.ino= i_detail.ino");
            
           
            while(rs3.next()){
                
                String name1 = rs3.getString("iname");
                
                String material1 = rs3.getString("material");
                
                String ino1 = rs3.getString("ino");
                                
                String price1 = rs3.getString("price");
                                
                String quantity1 = rs3.getString("quantity");
                                                           
                Object obj[] = {ino1,name1,price1,quantity1,material1};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StocksView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StocksView().setVisible(true);
            }
        });
    }
