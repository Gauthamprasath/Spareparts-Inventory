...
public class OrdersView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        o_view.setBackground(new java.awt.Color(21, 67, 96));
        o_view.setBorder(javax.swing.BorderFactory.createCompoundBorder());
        o_view.setFont(new java.awt.Font("Square721 BT", 1, 18)); // NOI18N
        o_view.setForeground(new java.awt.Color(229, 231, 233));
        o_view.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Order ID", "Vendor ID", "Item ID", "Quantity", "Price", "Amount", "Order Date", "Arrival Date"
            }
        ));
        o_view.setAlignmentX(1.0F);
        o_view.setAlignmentY(1.0F);
        o_view.setRowHeight(35);
        jScrollPane1.setViewportView(o_view);
    ...
    private void putData(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_putData
        // TODO add your handling code here:
        DefaultTableModel df = (DefaultTableModel)o_view.getModel();
        ...
        try{
            ...
            ResultSet rs3 = st.executeQuery("select * from vendor_orders, order_det where vendor_orders.order_id= order_det.o_id");
           
           
            while(rs3.next()){
                
                String oid = rs3.getString("order_id");
                
                String vid = rs3.getString("v_id");
                
                String ino = rs3.getString("ino");
                                
                String price = rs3.getString("price");
                                
                String quantity = rs3.getString("quantity");
                
                String od = rs3.getString("order_date");
                
                String ad = rs3.getString("arival_date");
                
                String amt = rs3.getString("amt");
                                                           
                Object obj[] = {oid,vid,ino,quantity,price,amt,od,ad};
    ...
    private javax.swing.JTable o_view;
